...
class Config(object):
    ...
    REDIRECT_PATH = "https://udacitycms-hsggc0fbb9cpfyav.canadacentral-01.azurewebsites.net/auth"
    # "/getAToken"  # Used to form an absolute URL; must match to app's redirect_uri set in AAD
